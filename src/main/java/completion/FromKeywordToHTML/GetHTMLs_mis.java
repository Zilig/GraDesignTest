 ...
 * @authorE Zilig Guan
 * @authorC 关哲林
 * @date 2021/8/26 22:01
 **/
public class GetHTMLs_mis {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        if(urlDirectory.isDirectory()){
            ...
            for(int txtIndex=begIndex; txtIndex<endIndex; txtIndex++){
                ...
                String directoryPath = outputDirPathMis + "/" + filename.substring(0, filename.lastIndexOf("."));
                //首先新建一个文件夹
