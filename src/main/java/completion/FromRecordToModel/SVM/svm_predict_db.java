...
public class svm_predict_db {
     ...
     * @throws IOException
     */
    private static void predict(DataOutputStream output, svm_model model, int predict_probability) throws IOException
    {
        int correct = 0;
        int total = 0;
        double error = 0;
...
//            else nowType = 1;
    ...
    public static void main(String argv[], ArrayList<float[]> paraTestDataList, ArrayList<Float> paramTestLabelList) throws IOException
    {
        ...
        try
        {
            ...
            predict(output,model,predict_probability);
            input.close();
            output.close();
        }
